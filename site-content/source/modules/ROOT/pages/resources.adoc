...
//start card  
[openblock,card resource-card text-center shadow relative level-Advaned]
----
[openblock,title mt-medium]
------
[discrete]
...
------
[.btn.btn--alt]
https://doordash.engineering/2021/02/02/building-a-more-reliable-checkout-service-with-kotlin/[Go to Resource,window=_blank]
------
----
//end card
